...
namespace Kortros.Updaters
{
    public class ElementIdUpdater : IUpdater
    {
        ...
        {
            updaterId = new UpdaterId(id, new Guid("CF7DCAA1-2647-4BA0-9E69-FF7A844C97C7"));
            RegisterUpdater();
            RegisterTriggers();
        }
        ...
        public void Execute(UpdaterData data)
        {
            ...
            foreach (ElementId addedElements in data.GetAddedElementIds())
            {
                ...
                if (element.GroupId.IntegerValue == -1)
                {
                    ...
                    {
                        Logger.Log.Error($"ElementID {addedElements.IntegerValue} error: {ex.Message}");
                    }
                }
            }
        }
        ...
        {
            return "ElementId & KRTRS_Группирование Updater";
        }
    }
}
